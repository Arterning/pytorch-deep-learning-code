...
if __name__ == '__main__':
    ...
    MODEL_SAVE_PATH = "models/06_pytorch_transfer_learning.pth"
    ...
    for i, image_path in enumerate(test_image_path_sample):
        ...
        plt.savefig(f"images/results_{i}.png", dpi=300, bbox_inches='tight')
        plt.close()
        print(f"Saved image: images/results_{i}.png")